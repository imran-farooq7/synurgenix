  ...
  return (
    <div className="pt-24">
      <motion.p
        ...
        `}
      >
        <span className="text-[#FF8157]">Asset</span> Disposal and Destruction
      </motion.p>
      <p
      ...
      >
        Manage the end-of-life of your IT assets securely, compliantly, and
        sustainably
      </p>
...
export default AssetHeroHeading;
