  ...
  return (
    <div className="pt-24">
      <motion.p
        ...
        `}
      >
        <span className="text-[#FF8157]">Application</span> Development
      </motion.p>
      <p
      ...
      >
        Turn your ideas into powerful, tailor-made software solutions.
      </p>
...
export default ApplicatioHeroHeading;
