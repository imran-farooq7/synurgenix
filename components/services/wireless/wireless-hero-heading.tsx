  ...
  return (
    <div className="pt-24">
      <motion.p
        ...
        `}
      >
        <span className="text-[#FF8157]">Wireless</span> Survey
      </motion.p>
      <p
      ...
      >
        Maximize wireless performance, coverage, and security—no matter where
        you operate.
      </p>
...
export default WirelessHeroHeading;
