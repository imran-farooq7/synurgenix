...
const Footer = () => {
  return (
    <footer className="">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 mx-auto max-w-7xl px-6 lg:px-0 pt-12 md:pt-24 pb-8">
        <div
      ...
      <div className="flex gap-y-2.5 flex-col md:flex-row items-center justify-between mx-auto max-w-7xl py-8">
        ...
        >
          © 2025 Synurgenix. All Rights Reserved.
        </p>
        <ul className={` flex gap-9 text-[#6D6D6D] `}>
          <li
            className={`text-inherit text-lg font-light  ${interSans.variable}`}
          >
